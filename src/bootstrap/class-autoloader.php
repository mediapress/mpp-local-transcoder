<?php
/**
 * MPP Local Transcoder Autoload Implementation.
 *
...
/**
 * Auto Loader for MPP Local Transcoder
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the PressThemes\MPP_Local_Transcoder\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/mpp-local-transcoder/src/bar/baz/class-qux.php:
 *
 *      new PressThemes\MPP_Local_Transcoder\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/mpp-local-transcoder/src/bar/baz-xyz/class-qux.php
 * The path/directory name should be all lowercase and the the class file is named as 'class-$classname.php'
 */
class Autoloader {

	/**
	 * Namespace root. eg. MPP_Local_Transcoder\\(escaped slashes);
	 *
	 * @var string
	 */
